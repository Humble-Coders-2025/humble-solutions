    ...
    <footer className="bg-[#0B0F19] text-white px-6 md:px-16 py-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10 items-start">
        ...
        <div className="flex flex-col gap-10 justify-start">
          ...
          <div className="flex gap-4 mt-2 justify-end mr-10">
            <a
              href="#"
        ...
        {/* 2. Contact Info */}
        <div className="flex flex-col text-sm leading-6 space-y-7">
          <div>
        ...
        {/* 3. Company Links */}
        <div className="flex flex-col gap-2 text-sm space-y-3">
